...
var m=n("UCAh")
var v=n("tbLP")
var y=function(e){var t=e.stacking
return{zIndex:t.topmost}}
n.d(t,"a",(function(){return D}))
var O,_,j,x,w,C,k,S,E,M,I,K,T
var z={componentId:"bgLNT",template:function(e){return"\n\n.bgLNT_bGBk{box-sizing:border-box;z-index:".concat(e.zIndex||"inherit","}")},root:"bgLNT_bGBk"}
var P=(O=Object(b["a"])(),O(_=(x=j=function(e){Object(s["a"])(t,e)
function t(){Object(a["a"])(this,t)
return Object(r["a"])(this,Object(l["a"])(t).apply(this,arguments))}return t}(g["a"]),j.displayName="PositionTarget",j.locatorAttribute="data-position-target",x))||_)
var R=(w=Object(b["a"])(),w(C=(S=k=function(e){Object(s["a"])(t,e)
function t(){Object(a["a"])(this,t)
return Object(r["a"])(this,Object(l["a"])(t).apply(this,arguments))}return t}(g["a"]),k.displayName="PositionContent",k.propTypes={children:p.a.node,placement:m["a"].placement},k.locatorAttribute="data-position-content",S))||C)
var D=(E=Object(b["a"])(),M=Object(f["i"])(y,z),E(I=M(I=(T=K=function(e){Object(s["a"])(t,e)
function t(){Object(a["a"])(this,t)
return Object(r["a"])(this,Object(l["a"])(t).apply(this,arguments))}Object(i["a"])(t,[{key:"render",value:function(){var e=this.props,n=e.children,i=e.id,a=e.trackPosition,r=e.placement,l=e.offsetX,s=e.offsetY,c=e.mountNode,d=e.target,p=e.insertAt,f=e.over,h=e.onPositioned,b=e.onPositionChanged,m=e.constrain,y=Object(o["a"])(e,["children","id","trackPosition","placement","offsetX","offsetY","mountNode","target","insertAt","over","onPositioned","onPositionChanged","constrain"])
var O=g["a"].pick(t.Target,n)
var _=g["a"].pick(t.Content,n)
return u.a.createElement(v["a"],Object.assign({},y,{target:d,renderTarget:O,id:i,shouldTrackPosition:a,placement:r,offsetX:l,offsetY:s,mountNode:c,insertAt:p,constrain:m,shouldPositionOverTarget:f,onPositioned:h,onPositionChanged:b,__dangerouslyIgnoreExperimentalWarnings:true}),_)}}])
t.displayName="Position"
return t}(c["Component"]),K.Target=P,K.Content=R,K.locatorAttribute="data-position",K.propTypes={children:p.a.node,target:p.a.oneOfType([h["a"],p.a.func]),over:p.a.bool,placement:m["a"].placement,offsetX:p.a.oneOfType([p.a.string,p.a.number]),offsetY:p.a.oneOfType([p.a.string,p.a.number]),onPositionChanged:p.a.func,onPositioned:p.a.func,trackPosition:p.a.bool,mountNode:m["a"].mountNode,insertAt:p.a.oneOf(["bottom","top"]),constrain:m["a"].constrain,id:p.a.string},K.defaultProps={trackPosition:true,placement:"bottom center",offsetX:0,offsetY:0,mountNode:null,target:null,insertAt:"bottom",over:false,onPositioned:function(e){},onPositionChanged:function(e){},constrain:"window",children:null,id:void 0},T))||I)||I)},Afqh:function(e,t,n){"use strict"
...
return c.a.createElement("li",{tabIndex:"-1",role:"option","aria-disabled":"true","aria-selected":"false",className:k()(Y.option,Object(x["a"])({},Y[n],n)),onClick:o},c.a.createElement("span",{className:Y.label},e))}},{key:"renderIcon",value:function(e){if("undefined"!==typeof e&&null!==e){var t=e
return c.a.createElement("span",{className:Y.icon},c.a.createElement(t,null))}}},{key:"renderOptions",value:function(){var e=this
...
if(i)return this.renderStaticOption(c.a.createElement(N["a"],{size:"x-small",renderTitle:i}))
...
return c.a.createElement("li",Object.assign({},m,{role:"option",key:d,id:"".concat(o,"_").concat(d),className:k()(Y.option,(i={},Object(x["a"])(i,Y.selected,g),Object(x["a"])(i,Y[s],s),Object(x["a"])(i,Y.highlighted,n===u),Object(x["a"])(i,Y.disabled,b),Object(x["a"])(i,Y.groupLabel,f),Object(x["a"])(i,Y.groupItem,h),i)),tabIndex:"-1","aria-selected":g?"true":"false","aria-disabled":b?"true":null}),c.a.createElement("span",{className:Y.label},p&&e.renderIcon(p),a))}))}},{key:"render",value:function(){var e=this
...
return c.a.createElement(L["a"],{style:r.style,className:Y.container,maxWidth:a||0,borderWidth:"small",borderRadius:"medium",shadow:"resting",background:"primary",__dangerouslyIgnoreExperimentalWarnings:true},!!this.props.expanded&&c.a.createElement("ul",{className:Y.optionsList,id:n,onKeyDown:this.props.onKeyDown,onKeyUp:this.props.onKeyUp,onBlur:this.props.onBlur,onClick:function(e){e.stopPropagation()
...
var ie=(G=Object(O["a"])(),Q=Object(B["i"])(V,oe),G(ee=Q(ee=(ne=te=function(e){Object(l["a"])(t,e)
function t(e){var n
Object(o["a"])(this,t)
...
n.setState((function(){return{focus:t}}),(function(){n.expanded&&!t&&n._timeouts.push(setTimeout((function(){Object(P["a"])(n._menu)||n.close(e)}),0))
t||n.props.onBlur(e)}))}
n.handleClick=function(e){e.preventDefault()
if(n.props.disabled||n.props.readOnly)return
if(n.expanded)n.close()
else{n._input&&!Object(j["a"])(n._input)&&n._input.focus()
...
n._defaultId=Object(D["a"])("Select")
n._optionsId=Object(D["a"])("Select-Options")
n._assistId=Object(D["a"])("Select-assistiveText")
return n}Object(i["a"])(t,[{key:"getSelectedIndex",value:function(e){if(e.selectedOption){var t=e.options.findIndex((function(t){return Z(t)===Z(e.selectedOption)}))
...
var o=this.props,i=o.size,a=o.disabled,r=o.readOnly,l=o.editable,s=o.required,u=o.width,d=o.options,p=o.selectedOption,f=o.loadingText,h=o.emptyOption,g=o.visibleOptionsCount,m=o.children,v=o.onStaticClick,O=o.assistiveText,_=o.layout,j=o.announcement,C=o.constrain
var S=Object(y["a"])(this.props,t.propTypes,["allowEmpty","assistiveText","value"].concat(Object(w["a"])(Object.keys(b["a"].propTypes))))
var E=d[this.state.highlightedIndex]
E&&this.expanded?S["aria-activedescendant"]="".concat(this._optionsId,"_").concat(E.id):S["aria-activedescendant"]=null
var z=c.a.createElement("label",{htmlFor:this.id,className:oe.label},this.props.label)
Object(M["a"])(this.props.label)||(z=c.a.createElement(K["a"],{__dangerouslyIgnoreExperimentalWarnings:true},z))
return c.a.createElement(b["c"],Object.assign({},Object(y["c"])(this.props,b["c"].propTypes),{as:"span",label:z,id:this.id,vAlign:"inline"===_?"middle":null,onMouseDown:this.handleMouseDown}),c.a.createElement("span",{style:{width:u||"auto"},className:k()(oe.inputWidth,(e={},Object(x["a"])(e,oe.invalid,this.invalid),Object(x["a"])(e,oe.focus,this.state.focus),e))},c.a.createElement("span",{ref:this.handleInputContainerRef,className:k()(oe.inputContainer,(n={},Object(x["a"])(n,oe.invalid,this.invalid),Object(x["a"])(n,oe.disabled,a),Object(x["a"])(n,oe[i],i),Object(x["a"])(n,oe.focus,this.state.focus),n))},m,c.a.createElement("span",{className:oe.inputLayout,onClick:this.handleClick},p&&this.renderIcon(),c.a.createElement("input",Object.assign({},S,{id:this.id,className:k()(oe.input,Object(x["a"])({},oe.editable,l)),onFocus:this.handleFocus,onChange:l?this.handleChange:null,onKeyDown:this.handleKeyDown,onKeyUp:this.handleKeyUp,onBlur:this.handleBlur,type:"text",ref:Object(R["a"])(this.props.inputRef,this.handleInputRef),role:"combobox","aria-expanded":this.expanded,"aria-owns":this.expanded?this._optionsId:null,"aria-describedby":this._assistId,"aria-controls":this.expanded?this._optionsId:null,"aria-autocomplete":l?"list":null,"aria-haspopup":"true",autoComplete:l?"off":null,required:s,"aria-required":s,"aria-invalid":this.invalid?"true":null,readOnly:!l,disabled:a||r})),c.a.createElement(W["a"],{width:"0.875rem",height:"0.875rem",className:oe.icon})))),c.a.createElement(I["a"],{open:this.state.expanded},c.a.createElement(T["a"],{trackPosition:this.expanded,placement:this.placement,onPositioned:this.handlePositioned,target:this._inputContainer,constrain:C},c.a.createElement(T["a"].Content,null,c.a.createElement($,{options:d,selectedOption:p,optionsId:this._optionsId,menuRef:this.handleMenuRef,visibleOptionsCount:g,loadingText:f,emptyOption:h,onStaticClick:v,onHighlightOption:this.highlightOption,onSelect:this.select,expanded:this.state.expanded,onKeyDown:this.handleKeyDown,onKeyUp:this.handleKeyUp,onBlur:this.handleBlur,highlightedIndex:this.state.highlightedIndex,maxWidth:this.props.optionsMaxWidth})))),c.a.createElement("span",{id:this._assistId,style:{display:"none"}},O),c.a.createElement(K["a"],{__dangerouslyIgnoreExperimentalWarnings:true},c.a.createElement("span",{role:"log","aria-live":"polite","aria-atomic":"true"},j)))}},{key:"id",get:function(){return this.props.id||this._defaultId}},{key:"expanded",get:function(){return this.state.positioned&&this.state.expanded}},{key:"placement",get:function(){return this.state.expanded?this.props.placement||"bottom stretch":"offscreen"}},{key:"invalid",get:function(){return this.props.messages&&this.props.messages.findIndex((function(e){return"error"===e.type}))>=0}},{key:"selectedIndex",get:function(){return this.getSelectedIndex(this.props)}}])
...
l&&Z(r)===Z(l)||i.onChange(e,r)}else if(l){if(i.allowEmpty&&""===n._input.value){i.onChange(e,null)
...
return n}Object(i["a"])(t,[{key:"findSelectedOption",value:function(e,t){var n=Z(t)
var o=e.find((function(e){return Z(e)===n}))
...
n.amendMatchesToState=function(e,t,o,i){if(o&&o.length>0){var a=[].concat(Object(w["a"])(e.selectedOption),Object(w["a"])(o))
...
n.handleKeyDown=function(e){var t=n.state,o=t.filterText,i=t.selectedOption,a=t.selectedOption.length;("Backspace"===e.key||"Delete"===e.key)&&a>0&&""===o&&Object(j["a"])(n._input)&&n.dismiss(e,i[a-1])
n.props.onKeyDown(e)}
n.handleSelect=function(e,t){n.cleanInput()
var o=[].concat(Object(w["a"])(n.state.selectedOption),[t])
...
e.stopPropagation()
var o=Z(t)
var i=n.state.selectedOption.filter((function(e){return Z(e)!==o}))
...
return n}Object(i["a"])(t,[{key:"getOptionMap",value:function(e){return e.reduce((function(e,t){e[Z(t)]=t
...
return t.map((function(e){var t=Z(e)
var o=n[t]
...
return a.filter((function(e){return!r[Z(e)]}))}},{key:"componentWillReceiveProps",value:function(e){var t=this
var n=!f()(this.props.options,e.options)
...
return c.a.createElement(pe["a"],Object.assign({className:ye.tag,key:Z(t)+t.label,title:t.label,text:e.props.formatSelectedOption(t,n),size:e.props.size,disabled:e.props.disabled,readOnly:e.props.readOnly},i))}))}},{key:"renderInputs",value:function(){var e=this
return this.state.selectedOption.filter((function(e){return e&&e.label})).map((function(t,n){return c.a.createElement("input",{type:"hidden",key:Z(t)+t.label,name:e.props.name,value:t.value})}))}},{key:"render",value:function(){var e=this
...
function je(e){var t=s["Children"].map(e,(function(e){var t=e.props,n=t.label,o=t.value,i=t.children
...
var xe,we,Ce,ke,Se
var Ee=(xe=Object(O["a"])(),we=Object(v["a"])("7.0.0",null,"Use @instructure/ui-select instead"),xe(Ce=we(Ce=(Se=ke=function(e){Object(l["a"])(t,e)
function t(e){var n
Object(o["a"])(this,t)
n=Object(a["a"])(this,Object(r["a"])(t).call(this,e))
n._input=null
...
n.state={options:i}
return n}Object(i["a"])(t,[{key:"componentWillReceiveProps",value:function(e){var t=je(e.children)
...
var _=n("VTBJ")
var j=n("o4+2")
function x(e){var t=e.borders,n=e.colors,i=e.forms,a=e.spacing,r=e.typography
...
var I=(w=Object(O["a"])(),C=Object(m["i"])(x,M),w(k=C(k=(E=S=function(e){Object(s["a"])(t,e)
function t(){var e
var n
Object(i["a"])(this,t)
...
t.displayName="Tag"
return t}(c["Component"]),S.propTypes={className:p.a.string,text:p.a.oneOfType([p.a.string,p.a.node]).isRequired,title:p.a.string,disabled:p.a.bool,readOnly:p.a.bool,dismissible:p.a.bool,margin:m["c"].spacing,onClick:p.a.func,elementRef:p.a.func,size:p.a.oneOf(["small","medium","large"]),variant:p.a.oneOf(["default","inline"])},S.defaultProps={size:"medium",dismissible:false,variant:"default",elementRef:void 0,className:void 0,title:void 0,disabled:false,readOnly:false,margin:void 0,onClick:void 0},E))||k)||k)},lzgt:function(e,t,n){"use strict"
...
var f=n("4Awi")
var h=n("sQ3t")
var g=function(e){Object(s["a"])(t,e)
function t(){Object(i["a"])(this,t)
return Object(r["a"])(this,Object(l["a"])(t).apply(this,arguments))}Object(a["a"])(t,[{key:"render",value:function(){var e=this.props,t=e.children,n=Object(o["a"])(e,["children"])
return Object(h["a"])(t,n)}}])
t.displayName="ComponentIdentifier"
return t}(c["Component"])
g.propTypes={children:p.a.node}
g.defaultProps={children:null}
g.pick=function(e,t){var n
u.a.Children.forEach(t,(function(t){Object(f["a"])(t,[e])&&(n=t)}))
return n}},oNNP:function(e,t,n){"use strict"
var o=n("D3zA")
...
//# sourceMappingURL=24-c-af2ea752c1.js.map